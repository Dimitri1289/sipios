...
<title>Заказать обслуживание сайта для Юр. лиц</title>
<style type="text/css">
<!--
.style1 {color: #d14828}
.style4 {color: #366b3c}
...
.style22 {font-size: 12px; margin-left:30px;  margin-right:30px; color:#366b3c}
.style24 {font-size: 12px}
.style25 {color: #e3fcfb}
-->
</style>
<!-- Chatra {literal} -->
<script>
...
{ 
            ...
            <tr>
			 ...
			 if ($_POST['paks'] == 4) echo 'selected="selected" checked="checked" '?>/>Дизайн сайта(15.000руб)</option>
             <option value="5"
			 ...
			 ?>/>Оплата на сайт(5.000 руб)</option>
             <option value="8"
			 ...
			 ?>/>Мобильный сайт(9.000 руб)</option>
                 ...
                 <tr>
                   ...
                   <td height="35" colspan="2"><input  name="url" type="text" size="26" value="<?php if (isset($_SESSION['url']))  echo $_POST['url'];?>"/>                     </td>
                 </tr>
                 <tr>
                   <td height="30">&nbsp;</td>
                   <td height="35"><span class="style1">*</span> Ваше ФИО:</td>
                   <td height="35" colspan="2"><input name="fio" type="text" size="26" value="<?php echo $_POST['fio']?>"/></td>
                 </tr>
                 <tr>
                   <td height="30">&nbsp;</td>
                   <td height="35"><span class="style1">*</span> Email:</td>
                   <td height="35" colspan="2"><input name="email" type="text" size="26" value="<?php echo $_SESSION['email']?>"/></td>
                 </tr>
                 <tr>
                   <td height="30" >&nbsp;</td>
                   <td height="35" ><span class="style1">*</span> Номер телефона:</td>
                   <td height="35" colspan="2"><input name="telefon" type="text" size="26" value="<?php echo $_SESSION['telefon']?>"/></td>
                 </tr>
                 <tr>
                   <td height="30" valign="middle">&nbsp;</td>
                   <td valign="middle"><span class="style1">*</span> Введите код:</td>
                   <td width="9%" height="30"><input name="robo" type="text" value="<?php if (isset($_SESSION['robo']))  echo $_SESSION['robo'];?>" size="5" /></td>
              ...
              <td width="19%" height="20" align="left" valign="top">
<a href="javascript:history.back()"><img width="191" height="39" src="img/fiz.png" border="0"  onmouseover="this.src='img/fiz1.png'"  onmouseout="this.src='img/fiz.png'"/></a></td>
              <td width="20%" height="20" align="right" valign="top" bgcolor="#e3fcfb">
<img src="img/uyr3.png" width="191" height="39">
                           </td>
              <td width="7%" rowspan="3"></td>
            </tr>
            <tr>
              <td height="4" valign="top" bgcolor="#e3fcfb"></td>
              <td width="20%" height="4" valign="top" bgcolor="#e3fcfb"></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="40">&nbsp;</td>
              <td colspan="2" rowspan="3" valign="top" bgcolor="#e3fcfb"><?php 
			  /*$litcoU == $_POST['litcoU'];*/
			  if (isset($_POST['standart']) or isset($_POST['paks'])) 
			 {echo '<br>
			   ';
...
echo '<span class="style22"><strong>› Сумма</strong> - 9.000руб.&nbsp;&nbsp;<strong>› ID заказа</strong> -'.$_SESSION['counter'].'&nbsp;&nbsp;<strong>› Время</strong> -'.$_SESSION['time'].'</span> ';					
			...
			echo  '<hr>
			 <span align="justify" class="style22">› Загрузите в систему  <strong>Карточку организации</strong><br><span align="justify" class="style22">›  Формат .pdf .doc .docx .jpg .png .jpeg <br></span><span align="justify" class="style22">› Разрешение 150-200 ppi<br></span> <span align="justify" class="style22">› Размер не более 1 Мб  </span>
			 <p class="style22">
...
<input class="" type="submit" value="СФОРМИРОВАТЬ СЧЁТ НА ОПЛАТУ" name="submit"/></p></form></p>';
}
?>			 </td>
              <td height="40">&nbsp;</td>
            </tr>
        ...
        $_POST['paks'] =  substr(htmlspecialchars(trim($_POST['paks'])), 0, 10);    
        $_POST['url'] =  substr(htmlspecialchars(trim($_POST['url'])), 0, 60);
		...
		if (empty($_POST['chek']))
			 ...
			 if (empty($_POST['url']))
             output_err(7);	 	 
		if (($_POST['robo'] == 7193 or $_POST['robo'] == 3979 or $_POST['robo'] == 9237 or $_POST['robo'] == 7628 or $_POST['robo'] == 6327) and !empty($_POST['email']) and !empty($_POST['fio']) and !empty($_POST['paks']) and !empty($_POST['chek']) and is_uploaded_file($_FILES["filename"]["tmp_name"]) and !empty($_POST['url'])) {
      $mess = '
...
КАРТОЧКА ОРГАНИЗАЦИИ ЗАКАЗЧИКА:'.$_FILES['filename'].'
...
<div  class="fixed_top">
<table align="center" class="menu_top" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="8%" ><input type="checkbox" id="nav-toggle" hidden>
        <nav class="nav">
...
spios.pro</a>        </h2>
        <ul>
            ...
            <li><a href="index.php?contact#bottom">Контакты</a>
            <li><a href="vopros_otvet.php#top">Вопрос-Ответ</a>
            <li><a href="index.php?zvonok#openModal">Онлайн чат</a>
            <li><a href="oferta.php#top">Договор оферта</a>
            <li><a href="forma.php">Оформить пакет</a>
                  </ul>
    </nav></input>
    <!-- 
    ...
    <td width="6%">&nbsp;</td>
    <td width="6%">&nbsp;</td>
    <td width="47%"><div align="center"><span class="style15 style25 style24">
      <?php 
	function getDayRus(){
    $days = array(
  ...
  echo"&nbsp;&nbsp;&nbsp;Московское время:&nbsp;".date("H:i:s");?>
    ...
    <td width="24%"><div align="right"><a href="index.php"> <img src="img/logo.png" width="83" height="30" /></a></div></td>
    <td width="3%">&nbsp;</td>
  </tr>
</table>
</div>
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2d4e4f">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;<?php if (isset($_POST['filename'])) echo  'есть ФАЙЛ'?></td>
